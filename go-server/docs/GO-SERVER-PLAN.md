...
- M6 quests/achievements+stores/bank/trade/craft — PARTIAL: store buy/sell/select + 20s cache, bank stash, NPC talk, containers/equip shipped in stub (e2e/m6 green); the quest/achievement half split out to M11 (DONE below). Remaining: trade sessions, `crafting/` 7-file recipes, enchant.
